...
export default function ElastiCachePanel() {
  ...
  async function handleRefresh() {
    ...
    const streamUrl = api.elasticacheRefreshStreamUrl();
  ...
  return (
    <section className="panel">
      <AlertBanner serviceType="elasticache" onAlarmsLoaded={setResourceAlarms} />
            ...
            <table className="data-table">
              ...
              <tbody>
                {sortedRgs.map((rg) => (
                  ...
                  >
                    <td>
                      {resourceAlarms.some(a => a.resource_id === rg.id && a.state === "ALARM") && (
                        <span className="alert-dot" title={`${resourceAlarms.filter(a => a.resource_id === rg.id && a.state === "ALARM").length} active alarm(s)`} />
                      )}
                    </td>
  ...
  return (
    <div className="detail-drawer">
      ...
      <div className="drawer-body">
        ...
        {detail && (
          <>
            <ResourceAlerts resourceId={cluster.id} />

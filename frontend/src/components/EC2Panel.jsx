...
export default function EC2Panel() {
  ...
  return (
    <section className="panel">
      <AlertBanner serviceType="ec2" onAlarmsLoaded={setResourceAlarms} />
    ...
    <>
      ...
      <div className="detail-drawer">
        ...
        <div className="drawer-body">
          ...
          {detail && (
            <>
              <ResourceAlerts resourceId={instance.id} />
              {/* ── Overview ── */}
...
function MetricChart({ title, hours, series, merged, yDomain, yFmt, tipFmt, emptyNote }) {
  ...
  return (
    <div className="metrics-chart-card">
      ...
      {isEmpty ? (
        <div className="metrics-chart-empty">{emptyNote ?? METRICS_EMPTY_NOTE}</div>
      ) : (

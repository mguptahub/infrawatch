  ...
  return (
    <div className="detail-drawer">
      ...
      <div className="drawer-body">
        ...
        {detail && (
          <>
            <ResourceAlerts resourceId={lb.name} />
...
export default function LBPanel() {
  ...
  return (
    <div className="panel" style={{ position: "relative" }}>
      <AlertBanner serviceType="elb" onAlarmsLoaded={setResourceAlarms} />
          ...
          <table className="data-table">
            ...
            <tbody>
              {sorted.map((lb) => (
                ...
                >
                  <td>
                    {resourceAlarms.some(a => a.resource_id === lb.name && a.state === "ALARM") && (
                      <span className="alert-dot" title={`${resourceAlarms.filter(a => a.resource_id === lb.name && a.state === "ALARM").length} active alarm(s)`} />
                    )}
                  </td>
